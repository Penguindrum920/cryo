...
export interface NimbusKeyboardRefs {
...
type NimbusKeyboardProps = JSX.IntrinsicElements["group"] & {
  keycapMaterial?: THREE.Material;
  knobColor?: string;
};

export const NimbusKeyboard = forwardRef<NimbusKeyboardRefs, NimbusKeyboardProps>(
  ({ keycapMaterial, knobColor, ...props }, ref) => {
    const { nodes, materials } = useGLTF(
      "/nimbus/keyboard.gltf",
      "/draco/",
    ...
    const keycapTexture = useTexture("/nimbus/goodwell_uv.png");
    keycapTexture.flipY = false;
    keycapTexture.colorSpace = THREE.SRGBColorSpace;

    const knurlTexture = useTexture("/nimbus/Knurl.jpg");
    ...
    const screenTexture = useTexture("/nimbus/screen_uv.png");
...
NimbusKeyboard.displayName = "NimbusKeyboard";

useGLTF.preload("/nimbus/keyboard.gltf", "/draco/");
